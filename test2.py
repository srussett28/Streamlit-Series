...
def main():
    ...
    if selected_option == "Title Page":
        ...
        st.image(intro_image, use_container_width=True)# Placeholder for Title Page content
        st.write(
            """
        ...
        tools = [
            ...
            "**Streamlit** - A Python library for building interactive web apps. It allows you to quickly create data apps without needing extensive web development skills. Install via `pip install streamlit`",
            "**Jupyter Notebook or JupyterLab** - Interactive computing environments ideal for exploratory data analysis and prototyping. Install via `pip install notebook`",
            "**VS Code or your preferred IDE** - A powerful and lightweight code editor for writing and debugging Python code. [Download](https://code.visualstudio.com)",
            "**Git for version control** - Helps you track changes in your code and collaborate with others effectively. [Download](https://git-scm.com)",
            "**SQL Editor (e.g., DBeaver or TablePlus)** - Tools for managing and querying databases. Useful for interacting with SQL databases during the series. [DBeaver](https://dbeaver.io) | [TablePlus](https://tableplus.com)",
            "**PostgreSQL (optional SQL database)** - A robust and widely-used open-source SQL database system. It’s optional but recommended for hands-on experience. [Download](https://www.postgresql.org)"
        ]
        ...
        st.write("Here are some essential Git commands:")
        git_commands = [
        ...
        st.write("VS Code can be used effectively with Git Bash for terminal programming and Python development. Here's how:")
        st.markdown("1. Configure Git Bash as your default terminal in VS Code by going to settings and searching for 'terminal' options.")
        ...
        st.write("Enhance your productivity with these VS Code extensions:")
        extensions = [
            "**GitLens** - Provides powerful Git capabilities like blame annotations and repository insights.",
            "**Git Ignore** - Helps you easily generate .gitignore files. Has tons of prebuilt templates",
    ...
    # Websites Section
        ...
        st.header("Websites")
        image_llm = "llm.png"
    st.image(image_llm, use_container_width=True)
    st.write("Here’s an expanded list of valuable websites to help you on your journey:")
    websites = [
    ...
    # GitHub Repositories Section
        ...
        t.header(" GitHub Repositories by most stars")
    image_github = "github.png"
    st.image(image_github, caption= "Zach Wilson in 2nd, NO WAY" ,  use_container_width=True)
    st.write("Explore these categorized repositories to enhance your learning and skills. Repo's were selected by searching each category with >1000 stars, and the top 5 repos (in english) were selected")
    ...
    st.write("These resources will help you enhance your skills and streamline your workflow:")
